...
# Simple tests for statistics.helpers
from statistics import mean
...
# Test target
from statistics import player_stats_from_data, summary_stats


def test_basic_counts():
    data = {
        'rounds': [
            {'id': 'r1', 'date': '2025-11-01T10:00:00', 'results': [
                {'player': 'A', 'score': 100, 'base': 10, 'rank': 1, 'dun': 2},
                {'player': 'B', 'score': 50, 'base': 5, 'rank': 2, 'dun': 1},
                {'player': 'C', 'score': -20, 'base': 0, 'rank': 3, 'dun': 0},
            ]},
            {'id': 'r2', 'date': '2025-11-02T10:00:00', 'results': [
    ...
    def test_date_filter():
        data = {
            'rounds': [
                {'id': 'r1', 'date': '2025-10-01T10:00:00', 'results': [
